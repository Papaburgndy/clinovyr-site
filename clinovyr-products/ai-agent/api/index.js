...
import { getHealthPayload } from "../src/lib/health.js";
import { createResendClient } from "../src/lib/resend.js";
import { createMemoryRedis, createRedisClient, createUpstashRedisClient, } from "../src/lib/redis.js";
const redis = createUpstashRedisClient(process.env.UPSTASH_REDIS_REST_URL, process.env.UPSTASH_REDIS_REST_TOKEN) ??
