...
function buildReportFallback(
  ...
  return {
    executiveSummary: `${company.name} is a ${brokerage.toLowerCase()} serving Placer County buyers and sellers. With ${company.size} team members, your assessment highlights ${topDrain.toLowerCase()} as the primary operational drain — especially the gap between inbound lead volume and consistent, fast follow-up. Agents in Roseville and Granite Bay markets compete on response time as much as on pricing expertise; AI-assisted qualification, listing copy, and nurture sequences can recover 8–15 hours per agent per week while improving conversion on $750K+ transactions.`,
    leadResponseProblem:
